...
class Algorithm {
 public:
  static void LevenshteinSearch(const std::string& word, size_t max_cost,
                                const TrieNode& trie,
  ...
  static void LevenshteinSearchRecursive(
      ...
      LevenshteinSearchResults& results, size_t max_cost);

  static void ProcessWords(Omegacomplete::Completions* completions,
                           Omegacomplete::DoneStatus* done_status,
                           const std::vector<String>* word_list,
                           const int begin, const int end,
                           const std::string& input, const bool terminus_mode);
  static float GetWordScore(const std::string& word, const std::string& input,
